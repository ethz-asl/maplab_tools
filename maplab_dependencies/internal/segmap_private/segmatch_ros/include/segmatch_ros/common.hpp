...
static segmatch::SE3 geometryMsgTransformToSE3(const geometry_msgs::Transform& transform) {
...
static geometry_msgs::Transform SE3ToGeometryMsgTransform(const segmatch::SE3& transform) {
