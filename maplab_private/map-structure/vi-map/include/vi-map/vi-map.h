...
class VIMap : public backend::ResourceMap,
 ...
 public:
  ...
  vi_map::Odometry6DoF::Ptr getMissionOdometry6DoFSensorPtr(
      const vi_map::MissionId& id) const;
  const vi_map::Relative6DoF& getMissionRelative6DoFSensor(
      const vi_map::MissionId& id) const;
  vi_map::Relative6DoF::Ptr getMissionRelative6DoFSensorPtr(
      const vi_map::MissionId& id) const;
  const vi_map::ArtifactDetection& getMissionArtifactDetection(
      const vi_map::MissionId& id) const;
  vi_map::ArtifactDetection::Ptr getMissionArtifactDetectionPtr(
      const vi_map::MissionId& id) const;
