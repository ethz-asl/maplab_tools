...
class VIMission : public Mission {
 ...
 public:
  ...
  inline bool operator==(const VIMission& lhs) const {
    ...
    is_same &= relative_6dof_id_ == lhs.relative_6dof_id_;
    is_same &= detection_id_ == lhs.detection_id_;
  ...
  void setRelative6DoFSensor(const aslam::SensorId& relative_6dof_id);
  void setArtifactDetectionSensor(const aslam::SensorId& detection_id);
  ...
  const aslam::SensorId& getRelative6DoFSensor() const;
  const aslam::SensorId& getArtifactDetectionSensor() const;

  bool hasNCamera() const;
  bool hasImu() const;
  bool hasLidar() const;
  bool hasOdometry6DoFSensor() const;
  bool hasRelative6DoFSensor() const;
  bool hasArtifactDetectionSensor() const;
 ...
 private:
  ...
  aslam::SensorId relative_6dof_id_;
  aslam::SensorId detection_id_;
