...
class ResourceCache {
 ...
 private:
  ...
  Cache<resources::Artifact>::ResourceTypeMap artifact_cache_;
...
template <>
typename ResourceCache::Cache<resources::Artifact>::ResourceDequePtr&
ResourceCache::getCachePtr<resources::Artifact>(const ResourceType& type);
