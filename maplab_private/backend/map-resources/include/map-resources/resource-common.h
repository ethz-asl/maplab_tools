...
const std::array<std::string, kNumResourceTypes> ResourceTypeNames = {
    {/*kRawImage*/ "raw_images",
     ...
     /*kArtifactDetection*/ "artifact_detections"}};
...
template <>
bool isSameResource(
    const resources::Artifact& artifact_A,
    const resources::Artifact& artifact_B);
